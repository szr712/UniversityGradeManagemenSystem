						...
						<table id="dynamic-table"
							...
							<thead>
								<tr>
									...
									<th class="center">地区总人数</th>
									
								</tr>
							</thead>
							<tbody>
								<%
									ArrayList<PlaceBean> pList = (ArrayList<PlaceBean>) request.getAttribute("plist");
									for (int i = 0; i < pList.size(); i++) {
								%>
								<tr>

									<td class="center"><%=pList.get(i).getPlace()%></td>
									<td class="center"><%=pList.get(i).getSum()%></td>
